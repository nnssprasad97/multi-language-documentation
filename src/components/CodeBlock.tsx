...
export function CodeBlock({ htmlContent }: { htmlContent: string }) {
    ...
    useEffect(() => {
        ...
        preElements.forEach((pre) => {
            if (pre.parentNode && pre.parentNode.querySelector(".copy-btn")) return;
            ...
            button.className = "absolute top-2 right-2 p-1 rounded bg-gray-700 text-white opacity-0 group-hover:opacity-100 transition copy-btn";
